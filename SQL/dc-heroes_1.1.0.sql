...
-- Dumping database structure for dc_heroes
CREATE DATABASE IF NOT EXISTS `dc_heroes` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `dc_heroes`;

-- Dumping structure for table dc_heroes.heroes
...
-- Dumping structure for table dc_heroes.ratings
CREATE TABLE IF NOT EXISTS `ratings` (
  `USER` varchar(50) NOT NULL,
  `HERO_ID` int(11) DEFAULT NULL,
  `HERO_RATING` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- Dumping data for table dc_heroes.ratings: ~5 rows (approximately)
/*!40000 ALTER TABLE `ratings` DISABLE KEYS */;
INSERT INTO `ratings` (`USER`, `HERO_ID`, `HERO_RATING`) VALUES
	('Admin_1', 1, 6),
	('Admin_1', 2, 9),
	('Admin_1', 3, 8),
	('Admin_1', 4, 2),
...
-- Dumping structure for table dc_heroes.teams
...
-- Dumping data for table dc_heroes.teams: ~5 rows (approximately)
...
-- Dumping structure for table dc_heroes.users
...
-- Dumping data for table dc_heroes.users: ~2 rows (approximately)
/*!40000 ALTER TABLE `users` DISABLE KEYS */;
INSERT INTO `users` (`USER_ID`, `USER_FIRSTNAME`, `USER_LASTNAME`, `USER_USERNAME`, `USER_PASSWORD`, `USER_PERMISSION`) VALUES
	(1, 'Admin1', 'Admin1', 'Admin_1', '$2y$10$SqgeNj.W5OLt9kHcsKK2duCoth/8exQUTfaPEPI3HIGbWE/hm.Vda', 'admin'),
	(5, 'Guylian', 'Gilsing', 'GuylianWasHier', '$2y$10$2jAC1GlLyYe5Bgs.Z9A4DeLJq.vnOpTY10I9kEfTM4w94nqf9TAaG', 'normal user'),
	(6, '1', '1', '1', '$2y$10$ciB0YaUikeYwzrblEk9ANOOv9CYRQCARLh5iMr2LYAjRPfn/bbDJW', 'normal user'),
	(7, 'Test', 'Test1', 'TestAccount1', '$2y$10$wVwSdXCq1YtL80As1Oh4lO/wd/JTSVPiNbUmkrBDVOVZpp/xQ11Y2', 'normal user');
